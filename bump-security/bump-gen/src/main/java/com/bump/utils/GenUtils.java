package com.bump.utils;

import com.bump.entity.ColumnEntity;
import com.bump.entity.TableEntity;
...
public class GenUtils {
	...
	public static String getFileName(String template, String className, String packageName){
		...
		String packagePathResources= "main" + File.separator + "resources" + File.separator;
		...
		if(template.contains("Dao.xml.vm")){
			return packagePathResources + "dao" + File.separator + className + "Dao.xml";
		}
